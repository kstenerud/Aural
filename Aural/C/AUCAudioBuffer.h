...
public:
	...
	void*const& leftChannelData() {return leftChannelData_;}
	void*const& rightChannelData() {return rightChannelData_;}
...
private:
	void*const leftChannelData_;
	void*const rightChannelData_;
	const unsigned int numFrames_;
	const unsigned int numBytes_;
	const AudioStreamBasicDescription format_;
