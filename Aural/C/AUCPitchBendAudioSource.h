...
#ifndef AURAL_PITCHBENDAUDIOSOURCE_H
#define AURAL_PITCHBENDAUDIOSOURCE_H
...
namespace aural {
	...
	class AudioSourcePitchBend: public AudioSource
	{
	public:
		AudioSourcePitchBend(AudioContext& context);
		AudioSourcePitchBend();
		...
		void* soundTouch() {return soundTouch_;}
...
#endif // AURAL_PITCHBENDAUDIOSOURCE_H
